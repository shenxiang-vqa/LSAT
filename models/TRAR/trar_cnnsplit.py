...
class ProbAttention(nn.Module):
    def __init__(self, __C ,mask_flag=True, factor=5, scale=None, attention_dropout=0.1, output_attention=False):
        ...
        self.linear_v = nn.Linear(__C.HIDDEN_SIZE//2, __C.HIDDEN_SIZE//2)
        self.linear_k = nn.Linear(__C.HIDDEN_SIZE//2, __C.HIDDEN_SIZE//2)
        self.linear_q = nn.Linear(__C.HIDDEN_SIZE//2, __C.HIDDEN_SIZE//2)
...
#         self.mhatt1 = MHAtt(__C)
        ...
        self.conv3 = nn.Conv1d(in_channels=__C.HIDDEN_SIZE // 2, out_channels=__C.HIDDEN_SIZE // 2, kernel_size=1)
        self.attention=ProbAttention(__C)
        self.ffn = FFN(__C)

        self.dropout1 = nn.Dropout(__C.DROPOUT_R)
        self.norm1 = LayerNorm(__C.HIDDEN_SIZE//2)
 ...
 #         temp=self.mhatt1(v=x, k=x, q=x, mask=x_mask)
#         print("@@@@@@@@@@@temp@@@@@@@@@@@@@@")
#         print(temp.shape)
...
#         print(csp_x.shape)
        ...
        csp_x = csp_x + self.dropout1(new_x.view( -1,
            64,
            256))
...
class EnDecoder(nn.Module):
    ...
    def forward(self, x, y, x_mask, y_mask,residerY,residerX):
         
        
        # SA-en
 
        y = self.norm1(y+residerY + self.dropout1(
        ...
        x = self.norm3(x+residerX+ self.dropout3(
